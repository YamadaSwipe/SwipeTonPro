-- Version finale corrigée - Suppression de RAISE NOTICE en dehors des blocs
...
SELECT 'Verification triggers notifications:' as status;
SELECT 
    trigger_name, 
    event_manipulation, 
    event_object_table, 
...
SELECT 'Autres triggers préservés (vérification):' as info;
...
-- 9. Résumé final
SELECT 'Correction terminée - Le trigger notifications est maintenant fonctionnel' as final_status;
