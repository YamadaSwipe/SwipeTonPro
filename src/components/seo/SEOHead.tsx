  ...
  return (
    <Head>
      ...
      <meta
        ...
        content={
          description ||
          'EDSwipe connecte les particuliers avec des artisans qualifiés. Obtenez des devis gratuits pour vos travaux.'
        }
      />
      ...
      {/* Canonical URL */}
      {canonical && (
        <link rel="canonical" href={`https://edswipe.fr${canonical}`} />
      )}
      ...
      <meta
        ...
        content={
          description ||
          'EDSwipe connecte les particuliers avec des artisans qualifiés.'
        }
      />
      <meta property="og:type" content="website" />
      <meta
        property="og:url"
        content={`https://edswipe.fr${canonical || '/'}`}
      />
...
export function HomeStructuredData() {
  return {
    ...
    url: 'https://edswipe.fr',
    description:
      'EDSwipe connecte les particuliers avec des artisans qualifiés pour tous types de travaux de rénovation.',
    potentialAction: {
      '@type': 'SearchAction',
