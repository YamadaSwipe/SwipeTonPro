...
export default function Home() {
    ...
    const loadFeaturedProjects = async () => {
      ...
      try {
        ...
        if (data && Array.isArray(data)) {
          ...
          const featured = publishedProjects.slice(0, 6).map((project: any) => ({
            id: project.id,
            title: project.title,
            category: project.category || project.work_type,
            city: project.city,
  ...
  const features = [
    {
      ...
      description: "Protection totale pour les deux parties avec contrôle d'identité",
      badge: "Sécurisé",
    ...
    },
    {
      ...
      description: "Le professionnel choisit votre projet, vous choisissez votre pro",
      badge: "Innovant",
      color: "text-blue-600"
    },
    {
  ...
  const stats = [
    { icon: Building2, value: "98%", label: "Satisfaction client", color: "text-orange-600" },
    { icon: HardHat, value: "500+", label: "Artisans certifiés", color: "text-emerald-600" },
    { icon: Award, value: "24h", label: "Premier contact", color: "text-blue-600" },
    { icon: Shield, value: "100%", label: "Contrôle qualité", color: "text-amber-600" }
  ];
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-background/90 via-muted/40 to-background/90">
            ...
            <div className="flex items-center justify-between gap-4">
              ...
              <div className="hidden xl:flex items-center gap-2 flex-shrink-0">
                <Link href="/particulier">
                  <Button size="sm" className="text-xs font-semibold px-3 py-1 bg-gradient-to-r from-primary to-primary/90 h-auto">
                    <Building2 className="mr-1 h-3 w-3" />
                    Particulier
                  </Button>
                </Link>
                <Link href="/professionnel">
                  <Button size="sm" variant="outline" className="text-xs font-semibold px-3 py-1 h-auto border-primary/50 hover:bg-primary/10">
              ...
              <div className="hidden lg:flex flex-1 justify-center">
                <Link href="/projets/parcourir" className="text-xs font-semibold text-white bg-gradient-to-r from-primary to-primary/90 flex items-center gap-1 px-4 py-2 rounded-md hover:shadow-lg transition-all hover:scale-105">
              ...
              <nav className="hidden md:flex items-center gap-4">
                <Link href="/fonctionnalites" className="text-xs font-medium hover:text-primary transition-colors">
                  Fonctionnalités
                </Link>
                <Link href="/comment-ca-marche" className="text-xs font-medium hover:text-primary transition-colors">
                  Comment ça marche
                </Link>
                <Link href="/pourquoi-nous" className="text-xs font-medium hover:text-primary transition-colors">
                  Pourquoi nous
                </Link>
            ...
            <div className="md:hidden border-t border-border/40 bg-card/95 backdrop-blur-sm">
              <div className="container mx-auto px-4 py-4 flex flex-col gap-3">
                ...
                <div className="flex gap-2">
                  <Link href="/particulier" className="flex-1" onClick={() => setMobileMenuOpen(false)}>
                    <Button size="sm" className="w-full text-sm font-semibold bg-gradient-to-r from-primary to-primary/90">
                      <Building2 className="mr-2 h-4 w-4" />
                      Particulier
                    </Button>
                  </Link>
                  <Link href="/professionnel" className="flex-1" onClick={() => setMobileMenuOpen(false)}>
                    <Button size="sm" variant="outline" className="w-full text-sm font-semibold border-primary/50">
                ...
                <div className="flex flex-col gap-1 pt-2 border-t border-border/40">
                  <Link href="/fonctionnalites" className="text-sm font-medium py-2 hover:text-primary transition-colors" onClick={() => setMobileMenuOpen(false)}>
                    Fonctionnalités
                  </Link>
                  <Link href="/comment-ca-marche" className="text-sm font-medium py-2 hover:text-primary transition-colors" onClick={() => setMobileMenuOpen(false)}>
                    Comment ça marche
                  </Link>
                  <Link href="/pourquoi-nous" className="text-sm font-medium py-2 hover:text-primary transition-colors" onClick={() => setMobileMenuOpen(false)}>
                    Pourquoi nous
                  </Link>
                </div>
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-5xl mx-auto text-center animate-fade-in">
              ...
              <p className="text-lg md:text-xl text-slate-600 max-w-3xl mx-auto mb-6 leading-relaxed animate-slide-up [animation-delay:200ms]">
                La première plateforme travaux où chacun a le pouvoir de choisir librement.
                <br />
                <span className="text-base">Artisans : choisissez les projets qui vous intéressent • Particuliers : choisissez avec qui échanger</span>
              </p>
              ...
              <div className="max-w-4xl mx-auto mb-10 animate-slide-up [animation-delay:600ms] bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                <h3 className="text-2xl font-bold text-slate-900 mb-6 text-center">Comment ça fonctionne</h3>
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="space-y-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <p className="font-medium text-slate-900">Les particuliers publient</p>
                        <p className="text-sm text-slate-600">Décrivez votre projet gratuitement</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <p className="font-medium text-slate-900">Les artisans proposent</p>
                        <p className="text-sm text-slate-600">Seuls les professionnels intéressés postulent</p>
                      </div>
                    </div>
                  </div>
                  <div className="space-y-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <p className="font-medium text-slate-900">Dialogue limité</p>
                        <p className="text-sm text-slate-600">Quelques messages pour vérifier le match</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <p className="font-medium text-slate-900">Match mutuel</p>
                        <p className="text-sm text-slate-600">Déblocage des contacts si accord réciproque</p>
                      </div>
                    </div>
                  </div>
                </div>
                <div className="mt-6 text-center">
                  <p className="text-lg font-semibold text-orange-600">Simple. Transparent. Sécurisé.</p>
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mb-10 animate-slide-up [animation-delay:800ms]">
                <Link href="/particulier">
                  <Button size="lg" className="bg-gradient-to-r from-orange-600 to-orange-500 hover:from-orange-700 hover:to-orange-600 text-white text-lg font-semibold px-10 py-4 shadow-xl hover:shadow-2xl hover:scale-105 transition-all rounded-full">
                    <Rocket className="mr-2 h-5 w-5" />
                    Publier mon projet gratuitement
                  </Button>
                </Link>
                <Link href="/professionnel">
                  <Button size="lg" variant="outline" className="border-2 border-blue-600 text-blue-600 hover:bg-blue-50 text-lg font-semibold px-10 py-4 hover:scale-105 transition-all rounded-full">
        ...
        <section id="fonctionnalites" className="py-20 bg-gradient-to-br from-gray-50 to-white">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-slate-500 max-w-3xl mx-auto">
                Contrairement aux plateformes classiques, SwipeTonPro ne force personne.<br />
            ...
            <div className="grid md:grid-cols-2 gap-16 max-w-7xl mx-auto">
              ...
              <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
                <div className="text-center mb-8">
                  ...
                  <h4 className="text-2xl font-bold text-orange-600">Pour les particuliers</h4>
                </div>
                ...
                <div className="space-y-6">
                  <div className="flex gap-4">
                    ...
                    <div>
                      <h5 className="font-bold text-lg mb-2">Publiez votre projet gratuitement</h5>
                      <p className="text-slate-600 mb-2">Expliquez votre besoin en quelques minutes.</p>
                      <p className="text-slate-500 text-sm italic">
                        Notre IA vous donne la situation de votre budget :<br />
                        Estimer du budget <span className="text-xs">(estimation en moyenne haute et ne peut etre pris pour base)</span>
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      <h5 className="font-bold text-lg mb-2">Recevez les candidatures d'artisans</h5>
                      <p className="text-slate-600">
                        Les professionnels intéressés par votre projet vous contactent.<br />
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      <h5 className="font-bold text-lg mb-2">Décidez librement</h5>
                      <p className="text-slate-600">
                        Si l'artisan vous inspire :<br />
                        <strong>vous matchez.</strong><br />
              ...
              <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
                <div className="text-center mb-8">
                  ...
                  <h4 className="text-2xl font-bold text-blue-600">Pour les artisans</h4>
                </div>
                ...
                <div className="space-y-6">
                  <div className="flex gap-4">
                    ...
                    <div>
                      <h5 className="font-bold text-lg mb-2">Accédez à des projets qualifiés</h5>
                      <p className="text-slate-600">
                        Consultez des demandes de travaux réelles près de chez vous.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      <h5 className="font-bold text-lg mb-2">Échangez avant tout paiement</h5>
                      <p className="text-slate-600">
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      <h5 className="font-bold text-lg mb-2">Débloquez le contact si le projet vous intéresse</h5>
                      <p className="text-slate-600">
                        Si le particulier souhaite également continuer :<br />
                        <strong>Match mutuel.</strong><br />
                        Vous décidez alors de débloquer les coordonnées.<br />
                        <em>Vous ne payez que lorsque le projet vous intéresse réellement.</em>
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="max-w-7xl mx-auto">
              ...
              {loadingProjects ? (
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {[...Array(6)].map((_, index) => (
                    <Card key={index} className="border-border/50 hover:shadow-lg transition-all hover:scale-105 border-2 border-primary/20">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {featuredProjects.map((project) => (
                    <Card key={project.id} className="hover:shadow-lg transition-all hover:scale-105 border-2 border-primary/20 bg-card/90">
                      <CardContent className="p-4">
                        {/* Badge de statut */}
                        <div className="flex items-center justify-between mb-3">
                          <Badge className={
                            ...
                            {project.status === 'published' ? 'Validé' : 'En attente'}
                          </Badge>
                ...
                <div className="text-center py-16">
                  ...
                  <h3 className="text-xl font-semibold mb-2">Aucun projet disponible</h3>
          ...
          <div className="container mx-auto px-4 text-center relative z-10">
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-xl mb-12 opacity-90">
                SwipeTonPro simplifie la rencontre entre particuliers et professionnels<br />
                dans un environnement libre, sécurisé et transparent
              </p>
              <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
                <Link href="/particulier">
                  <Button size="lg" variant="secondary" className="bg-white text-blue-600 hover:bg-gray-100 text-xl font-bold px-12 py-6 shadow-2xl hover:shadow-3xl hover:scale-105 transition-all">
                    <Rocket className="mr-3 h-6 w-6" />
                    Publier mon projet gratuitement
                  </Button>
                </Link>
                <Link href="/professionnel">
                  <Button size="lg" variant="outline" className="border-2 border-white text-white hover:bg-white hover:text-blue-600 text-xl font-bold px-12 py-6 hover:scale-105 transition-all">
          ...
          <div className="container mx-auto px-4">
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">
              <div className="flex items-center gap-2">
                ...
                <span className="font-heading font-bold text-sm">SwipeTonPro 2.0</span>
              </div>
