  ...
  async function saveEdit(tierId: string) {
    ...
    if (result.success) {
      toast({
        ...
        description: 'La grille tarifaire est active immédiatement.',
      });
      cancelEdit();
      loadTiers();
    } else {
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-400">
                Gestion des paliers de mise en relation
              </p>
            </div>
          </div>
        ...
        <div className="flex items-start gap-3 bg-blue-500/10 border border-blue-500/30 rounded-xl p-4 mb-8">
          ...
          <div>
            ...
            <p className="text-sm text-blue-400/80 mt-1">
              Tout changement est appliqué immédiatement. Les nouveaux matchs
              utiliseront le prix mis à jour. Les paiements déjà en cours ne
              sont pas affectés.
            </p>
          </div>
        </div>
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="text-sm text-gray-400">
                          {formatBudget(tier.budget_min, tier.budget_max)}
                        </span>
                      </div>
        ...
        <div className="mt-8 grid grid-cols-2 md:grid-cols-3 gap-4">
          ...
          <Card className="bg-gray-900 border-white/10">
            <CardContent className="p-4 text-center">
              ...
              <p className="text-2xl font-bold text-white">
                {Math.min(
                  ...tiers.filter((t) => t.is_active).map((t) => t.price_euros)
                )}
                €
              </p>
            </CardContent>
