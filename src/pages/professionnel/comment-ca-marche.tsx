  ...
  const steps = [
    {
      ...
      description: "Inscription gratuite en 2 minutes. Vérification professionnelle instantanée.",
      details: [
    ...
    },
    {
      ...
      description: "Trouvez les projets qui correspondent à vos compétences et votre zone géographique.",
      details: [
    ...
    },
    {
      ...
      description: "Communiquez gratuitement avec le client pour qualifier les besoins sans engagement.",
      details: [
    ...
    },
    {
      ...
      description: "Confirmez votre intérêt pour le projet. Le client choisit parmi les candidats.",
      details: [
    ...
    },
    {
      ...
      description: "UNIQUEMENT si le client vous choisit : payez selon le palier du projet et obtenez ses coordonnées.",
      details: [
    ...
    },
    {
      ...
      description: "Contactez le client, réalisez les travaux et recevez une notation pour votre réputation.",
      details: [
  ...
  const benefits = [
    {
      ...
      description: "Un match SwipeTonPro mène au projet dans 80% des cas. Le client vous a déjà choisi !",
      stats: "vs 5-10% sur les autres plateformes"
    },
    {
      icon: Euro,
      title: "ROI Exceptionnel",
      description: "Investissez €39 pour un projet de €800 avec 80% de chance de l'obtenir.",
      stats: "ROI moyen de 1,540%"
    },
    {
      icon: Shield,
      title: "Garantie Totale",
      description: "Satisfait ou remboursé sous 30 jours. Aucun risque pour vous.",
      stats: "100% de remboursement garanti"
    },
    {
      icon: Users,
      title: "Maximum 3 Concurrents",
      description: "Plus de concurrence massive. 1 chance sur 3 au lieu de 1 sur 20.",
      ...
      <div className="min-h-screen bg-gradient-to-b from-background to-muted/20">
          ...
          <div className="container mx-auto px-4 text-center">
            <div className="max-w-4xl mx-auto">
              <h1 className="text-4xl md:text-6xl font-heading font-black mb-6">
                Comment Ça Marche pour les <span className="text-blue-600">Professionnels</span>
              </h1>
              <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
                6 étapes simples pour trouver des projets qualifiés et développer votre activité
              </p>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-heading font-black mb-4">
                Votre Parcours en <span className="text-blue-600">6 Étapes</span>
              </h2>
            ...
            <div className="max-w-4xl mx-auto">
              {steps.map((step, index) => (
                <div key={index} className="flex flex-col md:flex-row gap-8 items-center mb-16 last:mb-0">
        ...
        <section className="py-20 bg-muted/30">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-heading font-black mb-4">
                Pourquoi Ça <span className="text-blue-600">Marche Vraiment</span>
              </h2>
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                Des avantages concrets qui font la différence avec les autres plateformes
              </p>
            </div>
            
            <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              {benefits.map((benefit, index) => (
                <Card key={index} className="border-border/50 hover:border-blue-600/50 transition-all hover:shadow-lg">
        ...
        <section className="py-20">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                Payez uniquement si la mise en relation réussit. Pas d'abonnement, pas de frais fixes.
              </p>
            </div>
              ...
              {pricing.map((plan, index) => (
                <Card key={index} className={`text-center border-2 ${plan.color} hover:shadow-lg transition-all hover:scale-105`}>
                  <CardContent className="p-6">
                    ...
                    <div className="text-sm text-muted-foreground font-medium mb-2">{plan.projectValue}</div>
                    <div className="bg-blue-600/10 rounded-lg p-2 mb-4">
                      <p className="text-sm font-bold text-blue-600">ROI : {plan.roi}</p>
                    </div>
                    <Link href="/professionnel/signup">
        ...
        <section className="py-20 bg-gradient-to-r from-blue-600 to-blue-400 text-white">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl mb-8 max-w-2xl mx-auto opacity-90">
              Rejoignez des milliers de professionnels qui augmentent leur chiffre d'affaires avec SwipeTonPro
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link href="/professionnel/signup">
