...
export default function ParticuliersCommentCaMarchePage() {
  const steps = [
    {
      ...
      description: "Déposez votre projet gratuitement en quelques minutes. Qualification humaine garantie 24h.",
      details: [
    ...
    },
    {
      ...
      description: "Les professionnels qualifiés postulent. Maximum 3 candidats pour éviter la surcharge.",
      details: [
    ...
    },
    {
      ...
      description: "Discutez avec les professionnels via messagerie sécurisée avant de vous engager.",
      details: [
    ...
    },
    {
      ...
      description: "Sélectionnez le professionnel qui vous convient le mieux. Validation mutuelle obligatoire.",
      details: [
    ...
    },
    {
      ...
      description: "Échangez vos coordonnées et commencez la communication directe avec votre professionnel.",
      details: [
    ...
    },
    {
      ...
      description: "Suivez vos travaux, puis notez le professionnel pour aider la communauté.",
      details: [
  ...
  const benefits = [
    ...
    },
    {
      ...
      description: "Les professionnels sont motivés (ils ont payé pour vous contacter) et donnent le meilleur d'eux-mêmes.",
  ...
  const guarantees = [
    {
      ...
      description: "Tous nos professionnels sont vérifiés : SIRET, assurances, compétences."
    },
    {
      icon: CheckCircle,
      title: "Qualification Humaine",
      description: "Chaque projet est vérifié par notre équipe dans les 24h suivant sa publication."
    },
    {
      icon: Heart,
      title: "Support Dédié",
      description: "Une équipe disponible 7j/7 pour vous accompagner à chaque étape de votre projet."
    },
    {
      icon: Star,
      title: "Garantie Satisfaction",
      description: "Si vous n'êtes pas satisfait, nous vous aidons à trouver une solution rapidement."
    }
  ];
      ...
      <div className="min-h-screen bg-gradient-to-b from-background to-muted/20">
          ...
          <div className="container mx-auto px-4 text-center">
            <div className="max-w-4xl mx-auto">
              <h1 className="text-4xl md:text-6xl font-heading font-black mb-6">
                Comment Ça Marche pour les <span className="text-emerald-600">Particuliers</span>
              </h1>
              <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
                6 étapes simples pour trouver le professionnel parfait et réaliser vos projets en toute sécurité
              </p>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-heading font-black mb-4">
                Votre Parcours en <span className="text-emerald-600">6 Étapes Simples</span>
              </h2>
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                Un processus pensé pour votre tranquillité d'esprit et votre sécurité
              </p>
            </div>
        ...
        <section className="py-20 bg-muted/30">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-heading font-black mb-4">
                Pourquoi Choisir <span className="text-emerald-600">SwipeTonPro</span>
              </h2>
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              {benefits.map((benefit, index) => (
                <Card key={index} className="border-border/50 hover:border-emerald-600/50 transition-all hover:shadow-lg">
              ...
              {guarantees.map((guarantee, index) => (
                <Card key={index} className="text-center border-border/50 hover:border-emerald-600/50 transition-all hover:shadow-lg">
                  <CardContent className="p-8">
                    ...
                    <h3 className="text-xl font-heading font-bold mb-4">{guarantee.title}</h3>
