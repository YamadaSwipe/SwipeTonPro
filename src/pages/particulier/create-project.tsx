...
export default function CreateProjectPage() {
  ...
  const validateForm = (): boolean => {
    ...
    if (formData.budget_min && formData.budget_max && parseInt(formData.budget_min) > parseInt(formData.budget_max)) {
      setError('Le budget minimum ne peut pas être supérieur au budget maximum');
      return false;
    }
    return true;
  };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!notificationResponse.ok) {
        console.error("Erreur notification projet:", await notificationResponse.text());
      } else {
        ...
        <Card className="w-full max-w-md">
          <CardContent className="p-6 text-center">
            ...
            <p className="text-gray-600 mb-4">
              Votre projet a été publié et les professionnels pourront maintenant y répondre.
            </p>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <Card>
              ...
              <CardContent>
                <div>
                  <Label htmlFor="additional_details">Détails additionnels</Label>
                  <Textarea
