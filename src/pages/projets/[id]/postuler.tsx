        ...
        <div className="container mx-auto px-4 py-8">
          <div className="max-w-2xl mx-auto">
            ...
            <div className="mb-6">
              ...
              <p className="text-muted-foreground">Projet: {project.title}</p>
            </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="bg-blue-50 p-4 rounded-md">
                    ...
                    <ul className="text-sm text-blue-800 space-y-1">
                      ...
                      <li>
                        • Si le client est intéressé, il pourra accepter votre
                        proposition
                      </li>
                      <li>
                        • Une fois accepté, vous pourrez communiquer directement
                      </li>
                      <li>
                        • Le déblocage des coordonnées sera payant pour le
                        professionnel
                      </li>
                    </ul>
                  </div>
