-- =====================================================
-- DIAGNOSTIC ET RÉPARATION D'URGENCE (VERSION FONCTIONNELLE)
...
-- Vérifier la structure de la table professionals
SELECT 
...
-- Vérifier les données PRO (colonnes existantes uniquement)
SELECT 
...
-- Données PRO pour sotbirida@gmail.com (colonnes garanties existantes)
...
FROM profiles 
WHERE email IN ('sotbirida@yahoo.fr', 'sotbirida@gmail.com', 'admin@swipotonpro.fr');
