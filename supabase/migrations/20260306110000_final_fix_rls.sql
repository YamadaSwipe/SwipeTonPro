-- SOLUTION COMPLÈTE POUR PERMISSIONS RLS
...
DROP POLICY IF EXISTS "Users service role key" ON users;
DROP POLICY IF EXISTS "Professionals can view user profiles" ON users;
...
-- RECÉER TOUTES LES POLITIQUES CORRECTEMENT
...
-- Politiques pour users (lecture seule)
